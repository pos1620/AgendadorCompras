 ...
 * @author home
 */
public class Adciona extends javax.swing.JFrame {
  ...
  prod.setValor(valorTxt.getAlignmentX());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Adciona.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
